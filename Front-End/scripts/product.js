...
function getCard(dataId, title, brand, category, rating, price, avatar, quantity) {
            ...
            fetch(`https://health-booster.onrender.com/cart/`, {
                ...
                if (res.cart.length !== 0) {
                    ...
                    if (sameProductFlag) {
                        ...
                        fetch(`https://health-booster.onrender.com/products/updateAfterAddCart/${e.target.id}`, {
                            method: "PATCH",
                            headers: {
                                'Content-type': "application/json"
                            },
                        ...
                        fetch(`https://health-booster.onrender.com/cart/add/`, {
                            method: "POST",
                            headers: {
                                'Content-type': "application/json",
                                "authorization": `Bearer ${saveToken.token}`
    ...
    wishlistButton.addEventListener("click", (e) => {
        ...
        fetch(`https://health-booster.onrender.com/wishlist/add/`, {
            method: "POST",
            headers: {
                'Content-type': "application/json",
                "authorization": `Bearer ${saveToken.token}`
